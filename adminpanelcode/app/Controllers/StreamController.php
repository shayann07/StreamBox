...
class StreamController extends BaseController {
    ...
    public function index(){
        ...
        return view('manage_stream', $data);
    }
    ...
    public function create(){
        ...
        $data['settings'] = $this->settings;
        return view('create_stream', $data);
    }
    ...
    public function createHandler(){
        ...
        if (empty($postedToken)) {
            ...
            if(empty($editID)){
                return redirect()->to(base_url('ns-admin/manage-stream'));
            } else {
                return redirect()->to(base_url('ns-admin/create-stream/'.$editID));
            }
        }
